...
const AUTHORITIES: AuthorityInput[] = [
  ...
  { domain: "Law", subDomain: "UK", name: "UK Ministry of Justice / Courts & Tribunals Glossary", shortName: "MoJ Glossary", jurisdiction: "UK", url: "https://www.gov.uk/guidance/court-and-tribunal-judiciary-glossary", tier: "primary", sourceType: "regulatory_body", description: "Official UK government court and tribunal terminology definitions.", sortOrder: 1 },
  ...
  { domain: "Medicine", subDomain: "US", name: "CDC Health Literacy Glossary", shortName: "CDC", jurisdiction: "US", url: "https://www.cdc.gov/health-literacy/glossary", tier: "reference", sourceType: "glossary", description: "Plain-language health and disease terminology from the US Centers for Disease Control.", sortOrder: 6 },
  { domain: "Medicine", subDomain: "US", name: "NIH MedlinePlus Medical Dictionary", shortName: "MedlinePlus", jurisdiction: "US", url: "https://medlineplus.gov/mplusdictionary.html", tier: "reference", sourceType: "reference", description: "Peer-reviewed, plain-language medical definitions backed by NIH.", sortOrder: 7 },
  ...
  { domain: "Astrophysics", subDomain: "Reference", name: "NASA Glossary of Astronomical Terms", shortName: "NASA Glossary", jurisdiction: "US", url: "https://www.nasa.gov/glossary", tier: "glossary", sourceType: "glossary", description: "Plain-language definitions of astronomical terms and concepts.", sortOrder: 5 },
