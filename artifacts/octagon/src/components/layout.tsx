...
import { Activity, Brain, ShieldAlert, GitMerge, Network, PlaySquare, ChevronLeft } from "lucide-react";
              ...
              <li key={link.href}>
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2 border ${
                    location === link.href || (link.href !== "/dashboard" && location.startsWith(link.href))
